...
def main():
    ...
    3) Type a question and Press 'Process'.🎈 """)
    st.write(css, unsafe_allow_html=True)



# session_state, il est neccessaire d'initialiser la conversation  
    ...
    with st.sidebar:
        ...
        if st.button("Process"):
            with st.spinner("Processing"):
                ...
                # session_state option streamlit pour faire perdurer la conversation et donc e pas tout reinialiser
